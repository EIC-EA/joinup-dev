...
Feature: Collection RSS feed.
  ...
  Scenario: Collection RSS feed.
    ...
    Then the page should contain an RSS autodiscovery link with title "Latest updates from the Indigo Monkey challenge" pointing to "/challenge/indigo-monkey/feed.xml"
    ...
    And the RSS feed channel elements should be:
      | title       | Latest updates from the Indigo Monkey challenge                                                                   |
      | description | This feed contains the latest published content from the Indigo Monkey challenge, including the newest solutions. |
      | link        | /challenge/indigo-monkey                                                                                          |
    And the RSS feed should have 7 items
    And the RSS feed items should be:
      | title                                                      | link                                                                    | description                                                                                   | publication date                | author          |
      | Discussion: Is the indigo coloration caused by their food? | /challenge/indigo-monkey/discussion/indigo-coloration-caused-their-food | <p>I was reading the technical paper and it seems their main food is the indigo cherries.</p> | Mon, 21 Jan 2019 13:00:00 +0100 | Aleta Jakeman   |
      | News: Monkeys favourite indigo amongst colors              | /challenge/indigo-monkey/news/monkeys-favourite-indigo-amongst-colors   | <p>Research results are out.</p>                                                              | Mon, 21 Jan 2019 12:36:00 +0100 | Aleta Jakeman   |
      ...
      | Event: Banana tasting                                      | /challenge/indigo-monkey/event/banana-tasting                           | <p>Testing more than 20 varities of bananas from all over the world.</p>                      | Fri, 14 Sep 2018 07:36:00 +0200 | Forest Robinson |
      | Custom page: Indigo variations                             | /challenge/indigo-monkey/indigo-variations                              | <p>The four major tones of indigo are listed here.</p>                                        | Sun, 15 Oct 2017 18:30:00 +0200 | Forest Robinson |
      | Document: Indigo technical paper                           | /challenge/indigo-monkey/document/indigo-technical-paper                | <p>All technical information about the rare indigo monkeys.</p>                               | Mon, 30 May 2016 12:21:00 +0200 | Aleta Jakeman   |

    When I go to the homepage of the "Dreaded Scissors" collection
    Then the page should contain an RSS autodiscovery link with title "Latest updates from the Dreaded Scissors challenge" pointing to "/challenge/dreaded-scissors/feed.xml"
    And the page should contain 1 RSS autodiscovery link
    When I click "RSS feed" in the "Entity actions" region
    Then I should see a valid RSS feed
    And the RSS feed channel elements should be:
      | title       | Latest updates from the Dreaded Scissors challenge                                                                   |
      | description | This feed contains the latest published content from the Dreaded Scissors challenge, including the newest solutions. |
      | link        | /challenge/dreaded-scissors                                                                                          |
    And the RSS feed items should be:
      | title                                   | link                                                               | description                                                                                                                                                                                            | publication date                | author     |
      | Solution: Shiny Ray                     | /challenge/dreaded-scissors/solution/shiny-ray                                                |                                                                                                                                                                                                        | Tue, 14 Aug 2018 17:36:00 +0200 | Otto Drake |
      | News: New metal alloy improves scissors | /challenge/dreaded-scissors/news/new-metal-alloy-improves-scissors | <p>It improves sharpness but they are more subject to rust.</p>                                                                                                                                        | Wed, 11 Apr 2018 09:00:00 +0200 | Otto Drake |
      ...
      | Event: Scissor sharpening party         | /challenge/dreaded-scissors/event/scissor-sharpening-party         | The place where to be if you want to keep cutting the paper at the best of your scissors possibilities. Lorem ipsum dolor sit amet consectetur adipiscing elit. Etiam sed consectetur turpis. In porta | Sun, 26 Nov 2017 14:18:00 +0100 | Otto Drake |
