...
Feature: Add comments
  ...
  Scenario Outline: Make an authenticated comment, skips moderation.
    ...
    And the email sent to "Comment moderator" with subject "COVID-19 Challenge: A new comment has been created." contains the following lines of text:
      ...
      | If you think this action is not clear or not due, please contact us at http |
    And the email sent to "Layonel Sarok" with subject "COVID-19 Challenge: A new comment has been created." contains the following lines of text:
      | text                                                                                    |
      | Miss Tales posted a comment in <parent> "<parent title>".                               |
      | To view the comment click                                                               |
      | If you think this action is not clear or not due, please us at http |
    And the email sent to "Korma Salya" with subject "COVID-19 Challenge: A new comment has been created." contains the following lines of text:
      | text                                                                                    |
      | Miss Tales posted a comment in <parent> "<parent title>".                               |
      | To view the comment click                                                               |
      | If you think this action is not clear or not due, please contact us at http |
