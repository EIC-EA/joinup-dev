...
Feature: Global search
  ...
  Scenario: Content can be found with a full-text search.
    ...
    When I visit the search page
    Then the "Content types" checkbox facet should allow selecting the following values "Challenges (2), Solution (1), News (1), Events (2), Document (1), Discussion (1), Release (1), Custom page (1), Licence (1), Video (1)"
